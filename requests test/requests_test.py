# use Python shell to work with requests

import requests

# put your real credentials here
EMAIL_ADDRESS = "admin@root.com"
PASSWORD = "admin123"
...
# we can use parmas dictionary
# posts = requests.get("http://127.0.0.1:8000/api/v1/posts/", params={"tags": ["1", "5"]})
print(
